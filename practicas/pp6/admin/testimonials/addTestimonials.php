...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $sql = "INSERT INTO testimonials (name, photo, info) VALUES ('$name', '$photo', '$info')";
    
    if($mysqli->query($sql)){
        header('Location: adminTestimonials.php?message=Testimonio añadido correctamente');
        exit();
    } else {
...
<head>
    ...
    <title>Añadir Testimonio - Rider Zone</title>
        ...
        <div class="form-container">
            ...
            <form action="addTestimonials.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="url" class="form-control" name="photo" placeholder="https://ejemplo.com/foto.jpg" required>
                    <small style="color: #b0b0b0;">Pega la URL de una imagen</small>
                </div>

                <div class="mb-3">
                    <label class="form-label">Testimonio *</label>
                    <textarea class="form-control" name="info" placeholder="Escribe el testimonio aquí..." required></textarea>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <a href="adminTestimonials.php" class="btn-cancel">
