...
if(!$project){
    header('Location: adminProjects.php?error=Proyecto no encontrado');
    exit();
}
...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $sql = "UPDATE projects SET title='$title', subtitle='$subtitle', description='$description', photo='$photo', link='$link' WHERE id=$id";
...
<head>
    ...
    <title>Editar Proyecto - Rider Zone</title>
        ...
        <div class="form-container">
            ...
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="subtitle" value="<?php echo $project['subtitle']; ?>" required>
                </div>

                <div class="mb-3">
                    <label class="form-label">Descripción *</label>
                    <textarea class="form-control" name="description" required><?php echo $project['description']; ?></textarea>
                </div>

                <div class="mb-3">
                    <label class="form-label">URL de la Imagen *</label>
                    <input type="url" class="form-control" name="photo" value="<?php echo $project['photo']; ?>" required>
                    <?php if($project['photo']): ?>
                        <img src="<?php echo $project['photo']; ?>" alt="Imagen actual" class="current-image">
                    <?php endif; ?>
                </div>

                <div class="mb-3">
                    <label class="form-label">Enlace (opcional)</label>
                    <input type="url" class="form-control" name="link" value="<?php echo $project['link']; ?>">
                </div>
