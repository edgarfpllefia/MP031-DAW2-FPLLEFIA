...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $sql = "INSERT INTO users (name, surname, email, password, role, photo, register_date) VALUES ('$name', '$surname', '$email', '$password_hasheada', '$role', '$photo', '$register_date')";
...
<head>
    ...
    <title>Añadir Usuario - Rider Zone</title>
        ...
        <div class="form-container">
            ...
            <form action ="addUsers.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="url" class="form-control" name="photo" placeholder="https://ejemplo.com/foto.jpg">
                    <small style="color: #b0b0b0;">Opcional</small>
                </div>
