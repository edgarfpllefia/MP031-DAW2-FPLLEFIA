...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $stmt = $mysqli->prepare("INSERT INTO Modulo (nombre, foto) VALUES(?, ?)");

    $stmt->bind_param('ss', $modulo, $foto);
    $stmt->execute();
...
<head>
    ...
    <title>Agregar Módulo - UAB</title>
    ...
    <div class="container">
        <div class="add-container">
            ...
            <form action="addModulos.php" method="POST">
                <div class="mb-3">
                    <label for="modulo" class="form-label fw-semibold">
                        <i class="bi bi-book-fill me-1"></i>
                        Nombre del Módulo:
                    </label>
                    <input type="text" class="form-control" name="modulo" id="modulo" placeholder="Ej: Desarrollo Web" required>
                </div>
