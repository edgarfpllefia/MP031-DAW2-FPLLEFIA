...
<head>
    ...
    <title>Afegir Lloguer - RentCar Admin</title>
...
<body>
    ...
    <div class="main-content">
        <!-- Top Bar -->
        <div class="top-bar">
            <h2><i class="bi bi-plus-circle me-2"></i>Afegir Nou Lloguer</h2>
        </div>

        <!-- Form Section -->
        <div class="content-section">
            <form action="addAlquiler.php" method="POST">
                <div class="row g-3">
                    <!-- ID User -->
                    <div class="col-md-6">
                        <label for="id_user" class="form-label">ID Usuari</label>
                        <input type="number" class="form-control" id="id_user" name="id_user" placeholder="1" min="1" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="id_vehiculo" name="id_vehiculo" placeholder="1" min="1" required>
                        <small class="text-muted">ID del vehicle a llogar</small>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="precio_total" name="precio_total" placeholder="360.00" min="0" step="0.01" required>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary-custom">
                        <i class="bi bi-save me-2"></i>Guardar Lloguer
                    </button>
