...
<head>
    ...
    <title>Editar Lloguer - RentCar Admin</title>
...
<body>
    ...
    <div class="main-content">
        <!-- Top Bar -->
        <div class="top-bar">
            <h2><i class="bi bi-pencil-square me-2"></i>Editar Lloguer</h2>
        </div>

        <!-- Alert Info -->
        <div class="alert-info-custom">
            <i class="bi bi-info-circle"></i>
            <strong>Editant lloguer ID: </strong> - Modifica els camps necessaris i guarda els canvis
        </div>
