...
<head>
    ...
    <title>Editar Vehicle - RentCar Admin</title>
...
<body>
    ...
    <div class="main-content">
        <!-- Top Bar -->
        <div class="top-bar">
            <h2><i class="bi bi-pencil-square me-2"></i>Editar Vehicle</h2>
        </div>

        <!-- Alert Info -->
        <div class="alert-info-custom">
            <i class="bi bi-info-circle"></i>
            <strong>Editant vehicle ID: </strong> - Modifica els camps necessaris i guarda els canvis
        </div>
            ...
            <form action="" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="url" class="form-control" id="foto" name="foto" value="" required>
                        <small class="text-muted">Modifica la URL per canviar la foto del vehicle</small>
                    </div>
                </div>
